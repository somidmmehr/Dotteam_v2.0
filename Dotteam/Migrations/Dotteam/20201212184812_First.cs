        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EstimatePrice = table.Column<int>(type: "int", nullable: false),
                    LastChange = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ProjectId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Presentaions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Presentaions_Projects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "Projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Comments_Presentaions_PresentationId",
                        column: x => x.PresentationId,
                        principalTable: "Presentaions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateIndex(
                name: "IX_Comments_PresentationId",
                table: "Comments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Presentaions_ProjectId",
                table: "Presentaions",
                column: "ProjectId");
        }
